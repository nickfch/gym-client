...
export interface ApiExerciseExercise extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Cardio'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text &
    ...
    > &
      Schema.Attribute.DefaultTo<'No Need'>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::exercise.exercise'
    >;
    muscle_group: Schema.Attribute.Enumeration<
      [
        'Chest',
        'Back',
        'Shoulders',
    ...
    >;
    video_example: Schema.Attribute.Media<'videos'> & Schema.Attribute.Required;
...
export interface ApiUserWorkoutUserWorkout extends Struct.CollectionTypeSchema {
  collectionName: 'user_workouts';
  info: {
    description: '';
    displayName: 'User_Workout';
    pluralName: 'user-workouts';
    singularName: 'user-workout';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiWorkoutWorkout extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_workout: Schema.Attribute.Relation<
      'manyToOne',
      'api::user-workout.user-workout'
    >;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_workouts: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-workout.user-workout'
    >;
    username: Schema.Attribute.String &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::user-workout.user-workout': ApiUserWorkoutUserWorkout;
